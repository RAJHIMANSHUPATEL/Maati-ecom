...
const SearchBar = ({ inputValue, setInputValue, onSubmit, className }) => (
  <form role="search" className={className} onSubmit={onSubmit}>
    <SfInput
      ...
      wrapperClassName="flex-1 h-10 !rounded-none !bg-transparent !ring-0 hover:!ring-0 focus-within:!ring-0 active:!ring-0 focus-within:!outline-none border-0 border-b border-rule px-0 pr-0"
      size="base"
      slotSuffix={
        <SfButton
          variant="tertiary"
